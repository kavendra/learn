...
namespace Betta\Services\Generator\Streams\Conference\AffiliateMeetingList;
...
use Betta\Services\Generator\Streams\Conference\AffiliateMeetingList\Handlers\RowHandler;
...
class Report extends AbstractReport
{
     ...
     * @var string
     */
    protected $title = 'Affiliate Meeting List Report';
     ...
     * @var string
     */
    protected $description = 'List all Conference Affiliate Meeting information';
    ...
    protected function loadMergeData($arguments)
    {
        ...
        $this->_affiliateMeeting = $this->getBuilder($arguments)->with($this->relations)->get()
                    ...
                    ->collapse();
        if($this->_affiliateMeeting->count() == 0) {
            $this->_affiliateMeeting = [RowHandler::headers()];
        }
