...
class HasManyThroughSecondary extends Relation
{
	/**
	...
	/**
	 * Secondary Key of the middle model
	 *
	 * @var string
	 */
	 ...
	 * @return void
	 */
	public function __construct(Builder $query, Model $farParent, Model $parent, $firstKey, $secondKey, $localKey, $secondaryKey)
	{
