...
namespace Betta\Services\Generator\Streams\Programs\Caterer;

use Exception;
use Betta\Models\Program;

class UploadedCreditCardAuthorizationGenerator
{
    /**
    ...
    {
        $all = collect([]);
        # only get the information from primary Catere
        $authorization = data_get($program->primaryCaterer, 'credit_card_authorization');
        # Attach if present
        if($authorization){
