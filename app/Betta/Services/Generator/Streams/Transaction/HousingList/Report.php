...
namespace Betta\Services\Generator\Streams\Conference\HousingList;
...
use Betta\Services\Generator\Streams\Conference\HousingList\Handlers\RowHandler;
...
class Report extends AbstractReport
{
     ...
     * @var string
     */
    protected $title = 'Housing List Report';
     ...
     * @var string
     */
    protected $description = 'List all Conference Housing information';
    ...
    protected function loadMergeData($arguments)
    {
        ...
        $this->_housing = $this->getBuilder($arguments)->with($this->relations)->get()
        ...
        if($this->_housing->count() == 0) {
            $this->_housing = [RowHandler::headers()];
        }
